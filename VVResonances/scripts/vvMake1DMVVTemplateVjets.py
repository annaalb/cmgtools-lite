    ...
    for filename in os.listdir(folder):
        for sampleType in sampleTypes:
            if filename.find(sampleType)!=-1:
                ...
                if filename.find("W") !=-1 or filename.find('Z') != -1:
                    print "applying k factors qcd"
                    dataPlotters2W[-1].addCorrectionFactor("kfactor_qcd",'tree')
                if filename.find("W") !=-1 or filename.find('Z') != -1:
                    print "applying k factors ew"
                    dataPlotters2W[-1].addCorrectionFactor("kfactor_ew",'tree')
                if filename.find("W") !=-1 or filename.find('Z') != -1:
                    print "applying k factors ew"
                    dataPlotters2W[-1].addCorrectionFactor("kfactor_ew",'tree')
...
if histogram_nominal.Integral()!=0 and histogram_noreweight.Integral()!=0 and histogram_doublereweight.Integral()!=0:
    ...
    print " sf ",sf 
    print " histogram_noreweight ",histogram_noreweight.Integral()
    ...
    l.AddEntry(finalHistograms["histo_nominal"],"template - QCD & EW","l")
    l.AddEntry(histogram_noreweight,"no k-factors","l")
    l.AddEntry(histogram_doublereweight,"QCD & 2 EW","l")
    l.Draw("same")
